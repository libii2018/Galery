...
export default function Cover({
  ...
  return (
    ...
    >
      <h1
        className={`absolute font-${fonts.font1} text-[60px] md:text-[70px] uppercase w-full m-0 p-0 text-center lg:text-[110px] top-1/2 left-1/2 text-white z-30 -translate-x-1/2 -translate-y-1/2`}
      >
        {eventName}
      </h1>
      ...
      <h2 className={`text-sm font-${fonts.font2} text-white`}>
        {eventCreator}
      </h2>
      ...
      <h2 className={`text-sm font-${fonts.font2} text-white text-right`}>
        {eventDate}
      </h2>
